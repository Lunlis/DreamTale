...
// Description: Создайте журнал для управления вашими заданиями
 ...
 * @param linebreak1
 * @text ===Main options===
 * @desc Основные параметры окна
 * @default ================
 *
 * @param Title
 * @text Title
 * @desc Установите заголовок QuestLog
 * @default QuestLog
 *
 * @param fontsize
 * @text Title Font Size
 * @type number
 * @desc Размер шрифта для названия сцены
 * @default 40
 * @min 1
 *
 ...
 * @type boolean
 * @desc Использовать динамический размер шрифта для описания? Плагин выберет подходящее значение от 100 до 10 размера шрифта
 * @default false
 * @on Activete
 * @off Deactivate
 *
 ...
 * @type number
 * @desc Отступ от левой/правой границы для Auto Sizer
 * @default 50
 *
 * @param descriptionSize
 * @text Quest Description Font Size
 * @type number
 * @desc Размер шрифта для описания квеста (если не динамический)
 * @default 20
 * @min 1
 *
 * @param infoalign
 * @text Quest Info Alignment
 * @desc Выберите, как согласовать информацию в описании квеста
 * @type select
 * @option Left
 * @value left
 * @option Center
 ...
 * @type number
 * @desc Размер шрифта названия квеста в списке квестов
 * @default 20
 * @min 1
 *
 * @param listAlign
 * @text Quest List Align
 * @desc Выберите способ выравнивания квеста в списке QuestLog
 * @type select
 * @option Left
 * @value left
 * @option Center
 ...
 * @param linebreak2
 * @text ===Text Options===
 * @desc Выберите свои условия
 * @default ================
 *
 * @param giverprefix
 * @text Giver Prefix
 * @desc Как отображается префикс «От:» в Quest Giver
 * @default From:
 *
 * @param areaprefix
 * @text Area Prefix
 * @desc Как отображается префикс «Area:» в Quest Area
 * @default Area:
 *
 * @param statusname
 * @text Status Name
 * @desc Как отображается «Статус:» для завершения квеста
 * @default Status:
 *
 * @param questcompleted
 * @text Quest Completed
 * @desc Слово, показывающее, завершено ли задание
 * @default Completed
 *
 * @param questongoing
 * @text Quest Ongoing
 * @desc Слово, показывающее, продолжается ли квест
 * @default Ongoing
 *
 * @param questfailed
 * @text Quest Failed
 * @desc Слово, которое будет отображаться, если квест провален
 * @default Failed
 *
 * @param linebreak3
 * @text ===Command Button===
 * @desc Установите настройки для команды меню
 * @default ================
 *
 * @param menucommand
 * @type boolean
 * @text Menu Command
 * @desc Добавьте команду Quest в меню игры
 * @default False
 * @on Show
 * @off Hide
 *
 * @param commandname
 * @text Command Name
 * @desc Задайте имя команды (если активировано)
 * @default QuestLog
 *
 * @param linebreak4
 * @text ===Graphic Settings===
 * @desc Установите графические настройки
 * @default ================
 *
 * @param titleFlag
 * @text Show QuestLog Title?
 * @type boolean
 * @desc Выберите, хотите ли вы показывать заголовок QuestLog
 * @default true
 * @on Show
 * @off Hide
 *
 ...
 * @param layoutSize
 * @text Layout Size
 * @desc Выберите размер макета QuestLog
 * @type select
 ...
 * @type boolean
 * @desc Выберите, хотите ли вы отображать кнопку отмены касания (если у вас ее нет, убедитесь, что в проигрывателе есть несенсорные команды)
 * @default true
 * @on Show
 * @off Hide
 *
 ...
 * @text Custom Skin
 * @type struct<skinSet>
 * @desc Если вы хотите использовать пользовательский скин, используйте эти настройки
 * @default {"skinFlag":"false","skinName":"","redT":"0","greenT":"0","blueT":"0"}
 *
 * @command line1
 * @text --- Quest Management ---
 * @desc Серия команд для управления вашими квестами
 *
 * @command CreateQuest
 * @text Create Quest
 * @desc Создайте новый квест.
 * @arg id
 * @type number
 * @text ID
 ...
 * @type icon
 * @text Icon
 * @desc Индекс значка, отображаемый для квеста.
 *
 * @arg name
 * @type string
 * @text Name
 ...
 * @type string
 * @text Long Title
 * @desc Более длинный заголовок для страницы описания. Оставьте поле пустым, чтобы использовать название квеста.
 *
 * @arg index
 * @type number
 * @text Index
 * @desc Индексный номер квеста в списке.
 *
 * @arg giver
 * @type string
 * @text Giver
 * @desc Информация о квестодателе.
 *
 * @arg area
 * @type string
 * @text Area
 * @desc Информация о месте проведения квеста.
 *
 * @arg description
 * @type string
 * @text Description
 * @desc Информация о квесте.
 *
 * @arg status
 * @text Status
 * @type select
 ...
 * @option Failed
 * @value failed
 * @desc Независимо от того, завершено ли задание, продолжается ли оно или провалено.
 * @default ongoing
 *
 * @command RemoveQuestNew
 * @text Remove Quest
 * @desc Удаляет поиск квестов по идентификатору или имени.
 *
 * @arg questID
 * @type number
 * @text Quest ID
 * @desc Идентификатор квеста, который нужно удалить (оставьте 0, если используете Имя).
 *
 * @arg questName
 * @text Quest Name
 * @desc Название квеста, который необходимо удалить (оставьте пустым, если используете идентификатор).
 * @type text
 *
 * @command SetCompletion
 * @text Set Quest Completion Parameter
 * @desc Устанавливает, выполнен ли квест или нет, выполняя поиск по идентификатору или имени.
 *
 * @arg questID
 * @type number
 * @text Quest ID
 * @desc Идентификатор квеста для редактирования. (Оставьте 0, если используете имя)
 * @default 0
 *
 * @arg questName
 * @text Quest Name
 * @desc Название квеста для редактирования. (Должно быть точное название, оставьте поле пустым, если вы используете ID)
 * @default
 *
 * @arg status
 * @text Status
 ...
 * @desc Редактирует описание квеста по идентификатору или названию.
 *
 * @arg questID
 * @type number
 * @text Quest ID
 ...
 * @desc Новое описание квеста.
 * @default
 *
 * @command EditQuestIcon
 * @text Edit Quest Icon
 * @desc Редактирует иконку квеста по идентификатору или названию.
 *
 * @arg questID
 * @type number
 * @text Quest ID
 ...
 * @type icon
 * @text New Icon #
 * @desc Новый номер значка.
 * @default 0
 *
 * @command line2
 * @text --- Plugin Functionality ---
 * @desc Серия команд для изменения слов и шрифтов.
 *
 * @command SetTitle
 * @text Set QuestLog Title
 * @desc Задайте заголовок QuestLog.
 *
 * @arg title
 * @text Title
 * @desc Новое название QuestLog.
 * @type string
 *
 * @command SetQuestTitleFontSize
 * @text Set QuestLog Title's Font Size
 * @desc Устанавливает размер шрифта названия квеста.
 *
 * @arg fontSize
 * @type number
 * @text Font Size
 * @desc Новое значение размера шрифта для названия квеста.
 *
 * @command SetQuestInfoFontSize
 * @text Set Quest Description Font Size
 * @desc Установите размер шрифта описания квеста.
 *
 * @arg fontSize
 * @type number
 * @text Font Size
 ...
 * @desc Установить размер шрифта имени квеста в списке квестов
 *
 * @arg fontSize
 * @type number
 * @text Font Size
 ...
 * @desc Установите префикс для дескриптора квеста «Giver:».
 *
 * @arg prefix
 * @text Prefix
 * @desc Новый префикс для квестодателя (включите «:», если хотите).
 * @type string
 *
 * @command SetAreaPrefix
 * @text Set Area Prefix
 * @desc Установите префикс для дескриптора «Область:» квеста.
 *
 * @arg prefix
 * @text Prefix
 * @desc Новый префикс для области квестов (включите «:», если хотите).
 * @type string
 *
 * @command SetStatusName
 * @text Set Status Prefix
 * @desc Установите префикс имени квеста «Статус:».
 *
 * @arg name
 * @text Name
 * @desc Новое название статуса квеста (при необходимости добавьте «:»).
 * @type string
 *
 * @command SetQuestCompleted
 * @text Set word for "Completed"
 * @desc Установите слово для выполненного задания.
 *
 * @arg completed
 * @text Completed
 * @desc Слово, которое будет отображаться при завершении квеста.
 * @type string
 *
 * @command SetQuestOngoing
 * @text Set word for "Ongoing"
 * @desc Задайте тему для текущего квеста.
 *
 * @arg ongoing
 * @text Ongoing
 * @desc Слово, которое следует показать для текущего квеста.
 * @type string
 *
 * @command SetCommandName
 * @text Set Command Name
 * @desc Устанавливает название квестовой команды в игровом меню.
 *
 * @arg commandName
 * @type string
 * @text Command Name
 * @desc Имя, которое нужно задать для команды задания в меню игры.
 *
 * @command line3
 ...
 * @desc Открывает сцену квеста.
 *
 * @command CheckQuestCompletion
 * @text Check if Quest is completed
 * @desc Проверяет, завершен ли квест, и сохраняет результат в переключателе или переменной.
 *
 * @arg selectMode
 ...
 * @option Switch
 * @option Variable
 * @desc Switch имеет значение TRUE, если завершено, FALSE, если нет. Переменная имеет значение 0 (продолжается), 1 (завершено) или 2 (не удалось)
 * @default Switch
 *
 * @arg questID
 * @type number
 * @text Quest ID
 * @desc Идентификатор квеста для проверки. (Оставьте 0, если используете имя)
 * @default 0
 *
 * @arg questName
 * @text Quest Name
 * @desc Название квеста для проверки. (Должно быть точное название, оставьте поле пустым, если используете идентификатор)
 * @default
 *
 * @arg switchID
 * @type number
 * @text Switch/Variable ID
 * @desc Идентификатор переключателя или переменной для установки
 * @default 1
 * @min 1
 *
 * @command line4
 * @text --- Graphic Changes ---
 * @desc Команда плагина для изменения графических настроек.
 *
 * @command changeGraphics
 * @text Change Graphic Settings
 * @desc Измените желаемые графические настройки.
 *
 * @arg titleFlag
 * @text Show QuestLog Title?
 * @type select
 ...
 * @help WD_Quest.js
 *
 * Плагин создает QuestLog, в котором будут храниться ваши квесты.
 *
